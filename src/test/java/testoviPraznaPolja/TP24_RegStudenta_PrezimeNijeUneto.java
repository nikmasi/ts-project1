 ...
 * @author TS
 */
public class TP24_RegStudenta_PrezimeNijeUneto {
    
    public TP24_RegStudenta_PrezimeNijeUneto() {
    }
    ...
    public void test24(){
        ...
        try{
            ...
            String message = driver.findElement(By.name("prezime")).getAttribute("validationMessage");
