 ...
 * @author TS
 */
public class TP23_RegStudenta_ImeNijeUneto {
    
    public TP23_RegStudenta_ImeNijeUneto() {
    }
    ...
    public void test23(){
        ...
        try{
            ...
            String message = driver.findElement(By.name("ime")).getAttribute("validationMessage");
