 ...
 * @author TS
 */
public class TP4_PrijavaKorisnika_NijeUnetoKorisnickoImeNiLozinka {
    
    public TP4_PrijavaKorisnika_NijeUnetoKorisnickoImeNiLozinka() {
    }
    ...
    public void test4(){
        ...
        try{
            ...
            String message = driver.findElement(By.name("k_ime")).getAttribute("validationMessage");
