 ...
 * @author TS
 */
public class TP27_RegStudenta_GodinaNijeUneta {
    
    public TP27_RegStudenta_GodinaNijeUneta() {
    }
    ...
    public void test23(){
        ...
        try{
            ...
            String message = driver.findElement(By.name("god_stud")).getAttribute("validationMessage");
