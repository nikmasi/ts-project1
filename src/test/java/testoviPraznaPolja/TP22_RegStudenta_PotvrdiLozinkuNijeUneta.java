 ...
 * @author TS
 */
public class TP22_RegStudenta_PotvrdiLozinkuNijeUneta {
    
    public TP22_RegStudenta_PotvrdiLozinkuNijeUneta() {
    }
    ...
    public void test22(){
        ...
        try{
            ...
            driver.findElement(By.name("lozinka_potvrdi")).sendKeys(potvrdi);
            ...
            String message = driver.findElement(By.name("lozinka_potvrdi")).getAttribute("validationMessage");
