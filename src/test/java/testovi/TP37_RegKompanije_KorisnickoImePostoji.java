 ...
 * @author TS
 */
public class TP37_RegKompanije_KorisnickoImePostoji {
    
    public TP37_RegKompanije_KorisnickoImePostoji() {
    }
    ...
    public void test37(){
        ...
        try{
            ...
            //String poruka="Korisnicko ime vec postoji u sistemu! Unesite drugo korisnicko ime.";
            //String message=driver.findElement(By.name(poruka)).getText();
            
            //Assert.assertTrue(message.contains(poruka));
            String poruka="Korisnicko ime vec postoji u sistemu! Unesite drugo korisnicko ime.";
            //String wel=driver.findElement(By.xpath("//body[contains(text(),'Korisnicko ime vec postoji u sistemu! Unesite drugo korisnicko ime.']")).getText();
            //Assert.assertTrue(wel.contains("Korisnicko ime vec postoji u sistemu!"));
