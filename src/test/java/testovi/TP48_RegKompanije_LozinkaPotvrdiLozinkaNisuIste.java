 ...
 * @author TS
 */
public class TP48_RegKompanije_LozinkaPotvrdiLozinkaNisuIste {
    
    public TP48_RegKompanije_LozinkaPotvrdiLozinkaNisuIste() {
    }
    ...
    public void test48(){
        ...
        try{
            ...
            String korisnickoIme="nordeus10";
            String lozinka="Sifra123$";
            String potvrdiLozinka="Sifra124$";
            ...
            driver.findElement(By.name("lozinka_potvrdi")).sendKeys(potvrdiLozinka);
            ...
            String poruka="Unete lozinke se ne poklapaju. Pokusajte ponovo.";
