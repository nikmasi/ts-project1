 ...
 * @author TS
 */
public class TP45_RegKompanije_PocetniKarakterNijeSlovo {
    
    public TP45_RegKompanije_PocetniKarakterNijeSlovo() {
    }
    ...
    public void test45(){
        ...
        try{
            ...
            String korisnickoIme="nordeus7";
            String lozinka="8ifra123$";
